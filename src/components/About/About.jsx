...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="flex flex-col items-center justify-center gap-5 bg-gray-50/10 text-gray-900 dark:bg-gray-900 dark:text-gray-200 relative"
    >
      <div className="w-[500px] h-[500px] rounded-full bg-primary -z-10 absolute bottom-30 right-0 blur-3xl opacity-20"></div>
