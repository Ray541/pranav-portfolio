...
const GitHubIcon = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M12 2C6.48 2 2 6.48 2 12c0 4.42 2.87 8.16 6.84 9.49.5.09.66-.22.66-.48 0-.24-.01-.87-.01-1.71-2.78.61-3.37-1.34-3.37-1.34-.45-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.61.07-.61 1 .07 1.53 1.02 1.53 1.02.9 1.53 2.35 1.09 2.92.83.09-.65.35-1.09.64-1.34-2.22-.25-4.55-1.11-4.55-4.95 0-1.09.39-1.98 1.03-2.67-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02A9.49 9.49 0 0112 6.8a9.49 9.49 0 012.5.34c1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.69 1.03 1.58 1.03 2.67 0 3.85-2.34 4.7-4.57 4.95.36.31.68.93.68 1.87 0 1.35-.01 2.44-.01 2.78 0 .26.16.58.67.48A10.01 10.01 0 0022 12c0-5.52-4.48-10-10-10z" />
  </svg>
);
...
const InstagramIcon = () => (
  ...
  >
    ...
    <path d="M16 11.37a4 4 0 1 1-7.75-1.87 4 4 0 0 1 7.75 1.87z" />
...
const SendIcon = () => (
  <svg fill="none" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <title>send</title>
      <path d="M0 16l12 4 4 12 16-32zM14.016 18.016l12-12-10.016 17.984z" fill="#fff"></path>
    </g>
  </svg>
);
